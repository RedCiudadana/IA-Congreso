...
function Home() {
  return (
    <>
      {/* Banner principal */}
      <div className="banner-badge bg_image center">
        <div className="inner">
          ...
          >
            <div className="row g-5 my-4 justify-content-center">
              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                <div className="single-image-generator">
                  <a href="#" className="thumbnail">
                    <img src="/assets/images/congreso/01_IMAGENES/IA_CONGRESO-07.png" alt="images" />
                  </a>
              ...
              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                <div className="single-image-generator">
                  <a href="#" className="thumbnail">
                    <img src="/assets/images/congreso/01_IMAGENES/IA_CONGRESO-08.png" alt="images" />
                  </a>
                  <div className="inner-content">
                    <div className="left-content-area">
              ...
              <div className="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                <div className="single-image-generator">
                  <a href="#" className="thumbnail">
                    <img src="/assets/images/congreso/01_IMAGENES/IA_CONGRESO-09.png" alt="images" />
                  </a>
                  <div className="inner-content">
                    <div className="left-content-area">
