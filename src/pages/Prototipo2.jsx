        ...
        {isVisible && (
          <div className="banner-badge bg_image mb-4 relative">
            ...
            <p className="dsic my-4">
              🌟 <b>¡Bienvenido al módulo para Análisis de Expedientes de Congreso de la República!</b> 🌟
              <br/>
              ...
              <br/>2️⃣ El asistente identifica criterios clave según lineamientos de Congreso de la República.
